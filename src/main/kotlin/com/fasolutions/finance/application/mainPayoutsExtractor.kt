...
import com.fasolutions.finance.integration.statusinvest.client.CompanyPayoutsClient
...
fun main() {
   ...
   // val mapper = CompanyProventsMapper()
    ...
    val client = CompanyPayoutsClient()

    val payouts = client.callForCompany("IRBR3")
    println(payouts)
